...
export const Hero = () => {
    return (
        <section className="bg-[#F5F5F5] pt-20 sm:pt-28 lg:pt-24 pb-12 sm:pb-16">
            <div className="max-w-7xl lg:min-h-[67vh] mx-auto px-4 sm:px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-26 items-center">
                {/* Left Column */}
                ...
                <div className="flex items-center justify-center order-first lg:order-last">
                    <div className="w-full h-full flex items-center justify-center">
                        <Image 
                            ...
                            width={1000} 
                            height={1000} 
                            className="w-full h-automax-w-md sm:max-w-lg lg:max-w-xl object-cover" 
                            loading="eager"
                        />
                    </div>
                </div>
            </div>
            <section className="bg-[#F5F5F5] py-6 mt-4 lg:mt-10">
